...
The recommended way of getting measurement values is using the mobile Matter controller application that comes with a graphical interface, performs measurements automatically and visualizes the data.
   ...
   .. tabs::
      ...
      .. group-tab:: nRF54L15 TAG
         ...
         If your tag is already programmed with one of Matter samples, you can use DFU over Bluetooth LE or Matter OTA Software Update.
...
.. note::
   ...
   To receive logs from the device connect to it via RTT.
